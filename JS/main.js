...
const shadowHeader = () => {
  ...
  // add a class if the bottom offset is greater than 50 of the header height
  this.scrollY >= 50
...
/*=============== SWIPER POPULAR ===============*/
// Ensure Swiper library is included in your HTML file
...
const scrollUp = () => {
  ...
  // add a class if the scroll is greater than 350
  this.scrollY >= 350
